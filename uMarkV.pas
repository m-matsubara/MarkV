...
procedure TForm1.ChangeView(nShift: Integer);
begin
...
procedure TForm1.UpdateEnableControls;
begin
...
procedure TForm1.btPrivClick(Sender: TObject);
begin
  ChangeView(-1);
end;
...
procedure TForm1.WebBrowserProcessFailed(Sender: TCustomEdgeBrowser;
  ProcessFailedKind: TOleEnum);
begin
  ShowMessage('aaa');
end;
